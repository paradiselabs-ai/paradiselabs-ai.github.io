            ...
            <div className="w-full md:w-1/2 lg:w-5/12 relative overflow-hidden p-4 md:p-0">
              <div className="relative h-full flex items-center justify-center p-4 md:p-12">
                ...
                <div className="absolute -top-64 -left-64 w-[400px] md:w-[600px] h-[400px] md:h-[600px] bg-[#f2d9e8]/5 rounded-full blur-3xl animate-pulse" />
                  ...
                  <h2 className="text-2xl md:text-4xl font-bold text-[#d6ddf4] mb-3 md:mb-6 text-center md:text-left">
                    Multi-Client Protocol
                  </h2>
                  <p className="text-sm md:text-lg text-[#d6ddf4]/80 leading-relaxed text-center md:text-left">
            ...
            <div className="w-full md:w-1/2 lg:w-7/12 p-4 md:p-12 lg:p-24 relative overflow-hidden">
              <div className="space-y-6 md:space-y-12 relative z-10">
                <div className="text-center md:text-left">
                  <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-[#d6ddf4] to-[#a9b4e8] bg-clip-text text-transparent mb-3 md:mb-6">
                    Streamline Development with MCP
                  </h1>
                  <p className="text-base md:text-xl lg:text-2xl text-[#d6ddf4]/80 leading-relaxed">
                    Create and connect to MCP servers effortlessly with GLUE.
                  </p>
                </div>

                <div className="space-y-4 md:space-y-8">
                  <div className="flex flex-col md:flex-row items-center md:items-start space-y-3 md:space-y-0 md:space-x-6 group hover:bg-[#d6ddf4]/5 p-4 rounded-xl transition-all duration-300">
                ...
                <div className="backdrop-blur-xl bg-[#d6ddf4]/5 border border-[#d6ddf4]/10 rounded-2xl p-4 md:p-8 transform hover:scale-105 transition-all duration-500">
                  <h4 className="text-lg md:text-xl font-semibold text-[#d6ddf4] mb-3 md:mb-4 text-center md:text-left">
                    What This Means for You
                  </h4>
                  <p className="text-sm md:text-base text-[#d6ddf4]/70 leading-relaxed text-center md:text-left">
