            ...
            <div className="mt-12 sm:mt-24 relative z-10">
              <div className="max-w-4xl mx-auto mb-8 sm:mb-16">
                <h2
                  ...
                  className="typography-h2 !leading-tight font-bold mb-4 sm:mb-6 text-[#61dafb] text-center bg-clip-text inline-block break-words w-full"
                >
                    ...
                    <div className="space-y-6 sm:space-y-8">
                      <details className="group" open>
                        <summary className="flex items-center cursor-pointer p-2 hover:bg-[#282c34]/30 rounded-lg transition-colors duration-300">
                          ...
                          <h3 className="typography-h3 !leading-tight font-semibold text-[#61dafb]">
                            App Configuration
                          </h3>
                        </summary>
                        <div className="pl-6 sm:pl-8 mt-3 sm:mt-4 text-[#abb2bf]">
