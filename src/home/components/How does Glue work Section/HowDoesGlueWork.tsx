          ...
          <div className="relative py-8 md:py-16">
            ...
            >
              <div className="w-full lg:w-3/5 p-4 md:p-8">
                <h2 className="text-[2rem] sm:text-[2.5rem] md:text-[3.5rem] lg:text-[5.5rem] font-bold mb-4 md:mb-8 text-[#d6ddf4] leading-tight animate-slide-up">
                  How Does GLUE Work?
                </h2>
                <p className="text-[1rem] sm:text-[1.1rem] md:text-[1.4rem] text-[#d6ddf4]/70 leading-relaxed animate-fade-in max-w-2xl">
              ...
              <div className="space-y-16 md:space-y-32">
                ...
                >
                  <div className="w-full md:w-1/2 text-center md:text-right transform-gpu hover:-translate-x-2 transition-all duration-500 p-4 md:p-10">
                    ...
                    <h3 className="text-[1.8rem] md:text-[2.2rem] font-bold mb-4 md:mb-6 text-[#d6ddf4] animate-slide-up">
                      Natural Team Collaboration
                    </h3>
                    <p className="text-[1rem] md:text-[1.2rem] leading-relaxed text-[#d6ddf4]/70 animate-fade-in max-w-xl md:ml-auto">
                ...
                >
                  ...
                  <div className="w-full md:w-1/2 text-center md:text-left transform-gpu hover:translate-x-2 transition-all duration-500 p-4 md:p-10">
                    ...
                    <p className="text-[1rem] md:text-[1.2rem] leading-relaxed text-[#d6ddf4]/70 animate-fade-in max-w-xl">
